...
import { FaEnvelope, FaLinkedinIn, FaMailBulk } from "react-icons/fa";
          ...
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              <i>
                <b className="purple">
                  {" "}
                  Javascript/Typescript, Java, Python and Go.{" "}
                </b>
              </i>
              <br />
              <br />
              ...
              <i>
                <b className="purple">
                  Web and Machine Learning Technologies and Products{" "}
                </b>
              </i>
              <br />
              <br />
